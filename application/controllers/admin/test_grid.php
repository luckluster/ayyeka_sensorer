...
class Test_grid extends MY_Controller {
	...
	public function index() {
		$orca_grid_container = Orca_grid::get_grid_container('my_grid_identifier', site_url('/admin/test_grid/testgrid_content_function'));
		//$orca_grid_container  = "";  
...
// 			)
		...
		$this->render_view("admin/test_grid/test_grid-index", $page_data, $page_params);
...
// 				),
				...
				'usr_android_registration_id' => array (
					'title' => 'Value',
					'type' => 'string'
				)
