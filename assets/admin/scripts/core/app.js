...
var App = function () {
    ...
    return {
        ...
        getServerData: function (sSource, aoData, fnCallback){
        	//Use _this later on
        	var _this = this;
        	$.ajax( {
                "dataType": 'json',
                ...
                "success": function(res, textStatus, jqXHR) {
                    if (res.sMessage) {
                    	_this.alert({type: (res.sStatus == 'OK' ? 'success' : 'danger'), icon: (res.sStatus == 'OK' ? 'check' : 'warning'), message: res.sMessage, place: 'prepend'});
                    } 
                    if (res.sStatus == 'OK') {
                ...
                "error": function() {
                   _this.alert({type: 'danger', icon: 'warning', message: 'Server error, please try again', place: 'prepend'});
                }
              } );
        }
