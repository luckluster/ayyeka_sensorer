    ...
    return {
        ...
        initDashboardDaterange: function () {
            ...
            function (start, end) {
            	...
            	var time_range = start.format('YYYY-MM-DD') + ',' + end.format('YYYY-MM-DD');
            	_this.initDashboardStats(time_range);
         ...
         */
        initDashboardStats: function (time_range){
        	if (!time_range){
        		var time_range = moment().subtract('days', 29).format('YYYY-MM-DD') + ',' + moment().format('YYYY-MM-DD');	
        	}
        	App.getServerData('server/ajax.php?method=fetch_dashboard_stats', {'time_range':time_range},
        			function(res, textStatus, jqXHR){
        				for (var i in res.sData){
        					$('#' + i).find('.number').text(res.sData[i]);
        				}
        			}
        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: 'You haven\'t visited ORCA for the last 10 days, hope all is good!',
